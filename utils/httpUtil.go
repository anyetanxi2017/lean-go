...
func (HttpUtil) Get(url string, params map[string]string, headers map[string]string) (string, error) {
	//new request
...
func (HttpUtil) Post(url string, body interface{}, params map[string]string, headers map[string]string) (*http.Response, error) {
	//add post body
	var bodyJson []byte
